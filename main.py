...
def run_neat(config):
    p = neat.Checkpointer.restore_checkpoint('neat-checkpoint-53')
...
start:
    ...
    save winnnerNN into best.pickle
    eval_genome:
    ...
    move_ai_paddle(net1, net2):
            output1 = net1.activate((left_paddle.y, ball.y, dist(left_paddle, ball)))
            ...
            output2 = net2.activate((right_paddle.y, ball.y, dist(right_paddle, ball)))
